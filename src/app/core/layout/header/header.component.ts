...
export class HeaderComponent implements OnInit {
  ...
  menuItems = [
    ...
    },
    {
      ...
      description: 'View stock and transactions',
      route: '/dashboard/stock-management',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>`
    },
    {
      label: 'Add Production',
      description: 'Record and track daily production',
