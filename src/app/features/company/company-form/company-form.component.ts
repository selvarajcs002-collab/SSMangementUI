        ...
        <form [formGroup]="companyForm" (ngSubmit)="onSubmit()" class="company-form">
          ...
          <app-grid-layout gap="20px">
            ...
            <app-input-field
              ...
              gridColumn="1 / span 1"
            ></app-input-field>
            <div *ngIf="companyForm.controls['phoneNumber'].invalid && companyForm.controls['phoneNumber'].touched" class="text-red-500 text-xs mt-1">
...
export class CompanyFormComponent implements OnInit {
  ...
  getErrorMessage(controlName: string): string | null {
    ...
    if (control.errors['pattern']) {
       ...
       if (controlName === 'phoneNumber') return 'Enter a valid 10-digit mobile number';
